...
if [ ! -v ACCOUNT ]; then
    echo 'ERROR: slurm ACCOUNT not set, exiting'
    exit
fi
...
do
    ...
    do
        ...
        do
            mkdir --parents                                                                                     ${REPO_DIR}/configs/${domain}/${proportion}/${fold}
            echo '{'                                                                                          > ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '    "model_'${proportion}${fold}'_'${domain}'" : {'                                        >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '        "train_data_path"      : "'${DATA_DIR}'/treebanks/folds/'${fold}'/train.conllu",'  >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '        "validation_data_path" : "'${DATA_DIR}'/treebanks/folds/'${fold}'/dev.conllu",'    >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '        "word_idx"             : 1,'                                                       >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '        "tasks"                : {'                                                        >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '            "dependency_task_name" : {'                                                    >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '                "task_type"  : "dependency",'                                              >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '                "column_idx" : 6'                                                          >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '            }'                                                                             >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '        },'                                                                                >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '        "domain"     : "'${domain}'",'                                                     >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json 
            echo '        "proportion" : "'${proportion}'",'                                                 >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json 
            echo '        "fold"       : "'${fold}'"'                                                        >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json 
            echo '    }'                                                                                     >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            echo '}'                                                                                         >> ${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json
            ...
            echo '    '${REPO_DIR}/scripts/misc/translate_jsonnet_to_json.py' \'                   >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo '        '${REPO_DIR}/configs/params.jsonnet'                \'                   >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo '        '${REPO_DIR}/configs/${domain}/${proportion}/${fold}/params.json         >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo ''                                                                                >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            ...
            echo '            '${REPO_DIR}/configs/${domain}/${proportion}/${fold}/data.json'   \' >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            ...
            echo '        '${DATA_DIR}/treebanks/folds/${fold}/test.conllu'                     \' >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh
            ...
            echo 'rm -rf '${REPO_DIR}/logs/${MODEL_NAME}                                           >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh
            echo ''                                                                                >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo '# run the official ud eval script'                                               >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo 'mkdir --parents '${REPO_DIR}/results/${domain}/${proportion}/${fold}             >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh
            echo ${REPO_DIR}/${VENV_NAME}/bin/python'                                           \' >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh
            echo '    '${REPO_DIR}/scripts/ud_tools/eval.py'                                    \' >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh
            echo '        '${DATA_DIR}/treebanks/folds/${fold}/test.conllu'                     \' >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo '        '${OUT_DIR_NAME}/test.conllu'                                         \' >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh 
            echo '        > '${REPO_DIR}/results/${domain}/${proportion}/${fold}/test.txt          >> ${REPO_DIR}/scripts/train/${domain}/${proportion}/${fold}.sh
